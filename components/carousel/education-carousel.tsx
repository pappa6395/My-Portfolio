...
const EducationCarousel = ({educations}: {educations: Educations[]}) => {
            ...
            <div className="flex gap-x-3 py-2">
                ...
                {educations.map((education, i) => {
                    return (
                        <div 
                            key={i}
                            className="grow border dark:bg-slate-900/80 bg-slate-100/80
                            shadow-md p-4 rounded-md pt-4 pb-4 space-y-2"
                        >
